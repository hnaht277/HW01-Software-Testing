...
| :--- | :--- | :--- | :--- | :--- | :--- |
| #0 | **Tool:** Gemini  <br> **Time:** 12:27 AM 07/06/2026  <br> **Prompt:** `"Requirement 1 – QA/QC Job Market 2026+ (40 pts): Find 10 QA/QC job postings PUBLISHED WITHIN 60 DAYS… tôi có yêu cầu như trên, tìm và đưa link cho tôi"` | 10 job listing summaries (Job 1–10) with company names, descriptions, required skills, and links (jobs_gemini1.png -> jobs_gemini5.png). | `INVALID` | Per ISTQB FL §2.1 (Test Planning), artifacts must be traceable to authoritative, live sources. All 10 job links returned "not found" / 404 errors when accessed, the AI failed to verify link availability before presenting them. This is a fundamental **usability failure**: the output was unusable as-is and required complete manual replacement. ISTQB FL §4.4.2 (Error Guessing) emphasizes that AI-generated content requires validation; here, zero links survived validation. | I manually searched LinkedIn and company career pages to locate and verify 10 actual active QA/QC job postings published within 60 days. Screenshots were retaken with my account name visible in the corner. All 10 postings met the ≥3 AI/LLM-skill requirement. The original AI-generated links were discarded entirely. |
| #1a | **Tool:** Gemini  <br> **Time:** 1:30 AM 07/06/2026  <br> **Prompt:** `"với yêu cầu: Requirement 2 – 20 Software Defects 2022–2026 (20 pts): Find 20 software defects… NEW: find 1 place where the AI is biased or hallucinates… Clarification: this applies to EVERY defect… tôi chưa hiểu lắm, giải thích yêu cầu lại cho tôi, ý đề kêu tìm lỗi hả, nhưng tìm lỗi của phần mềm gì?"` | 2 screenshots: prompt_explain_req2(1).png, prompt_explain_req2(2).png, Gemini clarified the requirement correctly: "AI bias/hallucination" refers to the AI *explaining* each defect making up (hallucinating) false details about those software defects, not finding bugs in AI itself. | `VALID` | This was a clarification prompt, not a content-generation task. The student's question reflected genuine confusion about the NEW requirement in HW01_Requirement.md. Gemini answered accurately by distinguishing between: (1) the software defects themselves (the 20 incidents), and (2) the AI's own bias/hallucination when *explaining* those defects. This is a correct interpretation per ISTQB FL §4.4.2, the student was asking for guidance on how to identify AI-generated errors, which is exactly the skill being assessed. | No fix required, prompt was for clarification only; output accepted as-is. |
...
| #4 | **Tool:** ChatGPT  <br> **Time:** 4:32 AM 08/06/2026  <br> **Prompt:** `"tìm 3 mistake trong ISTQB QA/QC Role Mindmap sau: [mermaid code]"` | 3 screenshots (find_mistake1.png → find_mistake3.png) identifying Mistake #1 (QA/QC not ISTQB Roles), Mistake #2 (UAT under Verification instead of Validation), and Mistake #3 (Test Process Improvement misplaced in CTAL Test Analyst Track). | `VALID` | All 3 mistakes were correctly identified and cited against ISTQB FL Syllabus §2.2 (role taxonomy), §1.3 (Verification vs. Validation), and CTAL Test Analyst syllabus. The analysis was thorough and aligned with ISTQB standards — no fabricated details, no overstatements. Output was accepted as-is. | No fix required; output accepted as-is. |
...
> "Report sections §Requirement 2 (20 Software Defects), §Requirement 3 (Test Cases for Physical Product), §ISTQB QA/QC Role Mindmap, and §Mistake Analysis (Mindmap Review) were initially generated by AI tools (Gemini, ChatGPT, Claude); I reviewed and corrected each artifact. For §Requirement 2, I appended an 'AI Bias/Hallucination in explanation' column to each defect entry, identifying fabricated or overstated details against primary source articles. For §Requirement 3, I added 3 missing edge cases (TC10, TC15, TC16) and renamed all Test Case Objectives to assertive statements. For the Mindmap, I identified 3 factual mistakes per ISTQB FL Syllabus §2.2 and CTAL syllabus and replaced the mindmap with a corrected version. For §Mistake Analysis, ChatGPT correctly identified all 3 mistakes and was accepted as-is with no corrections needed. The detailed AI Audit Report is attached as Appendix A. I confirm I did not use AI to generate any artifact listed in the prohibited category."
